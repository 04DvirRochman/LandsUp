...
export default class MainWebsite extends Component {
    ...
    constructor(){
        ...
        this.state = {
            ...
            links:{ Home: "/", About: "/About" ,MyFlights : "/MyFlights"  , Login :"/Login"}
        }
    }
        ...
        return (
            <div>
                ...
                <Routes>
                    ...
                    <Route path={links.Login}  HomePageLing = {links.Home} setConnectedUser = {this.setConnectedUser} element={<Login/>} />
                    <Route path={links.MyFlights} element={<MyFlights connectedUser={connectedUser}/>} />
                </Routes>
                <SiteFooter />
            </div>
        )
